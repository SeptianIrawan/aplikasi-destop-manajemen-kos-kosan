 ...
 * @author oc
 */
public class datapenyewa1 extends javax.swing.JFrame {
...
if (result == JFileChooser.APPROVE_OPTION) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(datapenyewa1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new datapenyewa1().setVisible(true);
            }
        });
    }
